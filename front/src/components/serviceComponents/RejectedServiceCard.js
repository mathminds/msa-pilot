...
<div className="indicator z-10">
    <div className="w-[450px] h-[50px] xs:border-4 xs:border-black xs:w-[600px] xs:h-[100px] md:w-[390px] md:h-[190px] grid place-content-center grid-cols-12 grid-rows-12 z-0">
        {thirdPartyRecipients.length === 0 && (
            ...
            <div className='absolute w-full h-full bg-[#0F1823] bg-opacity-95 rounded-lg md:rounded-3xl overflow-hidden text-gray-400 backface-hidden'>

                <div className="border-0 border-red-500 rounded-md bg-white px-4 text-gray-400">
                    <h3 className="pt-2 font-bold text-2xl text-gray-400">
                    [철회] {title}
                    </h3>
                    <div className="text-sm pt-1 text-gray-400">정보수신자: {serviceProvider}</div>
                    <div className="text-sm pt-1 text-gray-400">활용 데이터: {details.join(', ')}</div>
                    <div className="text-sm pt-1 text-gray-400">정보전송자: 신한은행, 우리은행, 현대카드 등</div>
