        ...
        <div className="flip-card-container">
            <div className={`flip-card ${isFlipped ? 'flipped' : ''}`}>
                <div className="flip-card-front grid grid-cols-12 grid-rows-12">
                    ...
                    <div className='pt-4 border-2 border-red-500 rounded-md bg-white px-4 text-black w-full h-full grid grid-cols-12 grid-rows-12'>
                        ...
                        <li className='text-lg pt-1 row-start-3 row-end-5 col-start-1 col-end-13 '>정보수신자: {serviceProvider}</li>
                        <li className='text-lg  col-start-1 col-end-13 row-start-5 row-end-7 '>활용 데이터: {details.join(', ')}</li>
                        <li className='text-lg  col-start-1 col-end-13 row-start-7 row-end-9 '>정보전송자: 신한은행, 우리은행, 현대카드 등</li>
                        </ul>
                        <div className='py-2 border-black bg-white w-full col-start-1 col-end-13 row-start-9 row-end-13 '>
