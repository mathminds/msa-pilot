...
const Service = () => { 
    ...
    return (
        <div class="bb flex font-serif">
  <div class=" flex-none w-52 relative">
    <img src="/b.png" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
  </div>
  <form class=" flex-auto p-6">
    <div class=" flex flex-wrap items-baseline">
      ...
      <div class="br text-xs leading-6 font-medium uppercase text-slate-500">
        In stock
      </div>
    </div>
    <div class="br flex items-baseline mt-4 mb-6 pb-6 border-b border-slate-200">
      <div class="br space-x-1 flex text-sm font-medium">
        <label>
