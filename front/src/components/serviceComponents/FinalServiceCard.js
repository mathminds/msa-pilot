            ...
            <div className={`flip-card h-[150px] w-[300px] md:h-[200px] md:w-[400px] ${isFlipped ? 'flipped' : ''} `}>
                <div className="flip-card-front md:flip-card-front-md grid grid-cols-12 grid-rows-12 ">
                    ...
                    <div className='pt-2 md:pt-4  border-red-500  bg-white px-4 text-black w-full h-full grid grid-cols-12 grid-rows-12 rounded-xl'>
                        ...
                        <div className='py-2 border-black bg-white w-full col-start-1 col-end-13 row-start-9 row-end-13 flex justify-center md:justify-between items-end'>
                            {/* <div className='grid grid-cols-12 grid-rows-2'> */}
                                <div className='bg-blue-500 text-white font-bold btn btn-xs md:btn-sm col-start-1 col-end-5' onClick={handleOpenModal}>
                                    서비스 상세보기
                                </div>
                                <div className='bg-red-500 text-white font-bold btn btn-xs md:btn-sm col-start-5 col-end-9' onClick={handleOpenRejectModal}>
                                    서비스 철회하기
                                </div>
