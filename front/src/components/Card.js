...
const Card = ({ title, count, details, button1, button2 }) => {
    return (
        <div className="card p-4 rounded-lg mb-4 border-2 mx-4 items-center flex-col">
            ...
            <div className='flex lg:flex-row md:flex-col sm:flex-col space-around h-24  w-full object-cover md:h-full md:w-48 md:text-4xl'>
                ...
                <div className="lg:flex-col md:flex-row sm:flex-col md:ml-0 sm:ml-0 sm:mx-2 md:justify-center pl-8" >
                    <a href={button1}>
