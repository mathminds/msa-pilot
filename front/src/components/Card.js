        ...
        <div className="card p-4 rounded-lg mb-4 border border-red-200 mx-4 items-center flex-col">
            ...
            <div className='flex lg:flex-row md:flex-row sm:flex-row space-around h-24 w-72 w-full object-cover'>
                ...
                <div className= "ml-4 mt-1 lg:flex-col md:flex-row sm:flex-col md:ml-0 sm:ml-0 sm:mx-2 flex-col" >
                    ...
                    <a href={button2}>
                        <button className="border border-black bg-[#D7E9FF] md:mx-2 md:mt-4 mt-4 text-xs md:px-2 md:py-1 text-black cursor-pointer rounded sm:text-2xs sm:mx-0 sm:mt-1 sm:w-100%">
                            탐험하기
                        </button>
                    </a>
                </div>
